...
def create_or_edit_event(request, calendar_slug, event_id=None, next=None,
    ...
    if form.is_valid():
        ...
        event.save()
        return HttpResponseRedirect(reverse('opendri.schedules.details', None, [calendar.id]))
...
def destroy_event(request, calendar_slug, event_id=None, next=None,
    ...
    return HttpResponseRedirect(reverse('opendri.schedules.details', None, [str(calendar.id)]))
